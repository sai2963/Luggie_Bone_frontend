...
function ProductDetail() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://luggie-bone-backend.vercel.app/api/products/${id}`
        );
  ...
  const handleAddToCart = () => {
    ...
    if (selectedVariant) {
      const { id: variantId, price, title: variantTitle } = selectedVariant;
      const { title: productTitle, id: productId } = product.product;
      dispatch(
        addToCart({
          variantId,
          productId,
      ...
      alert(
        `Added to cart: ${productTitle} - ${variantTitle} (Quantity: ${quantity})`
      );
    } else {
  ...
  const handleBuyNow = () => {
    ...
    if (selectedVariant) {
      alert(
        `Buy Now: ${product.product.title} - ${selectedVariant.title} (Quantity: ${quantity})`
      );
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-3">
              {product.product.images &&
                product.product.images.slice(0, 10).map((image, index) => (
                  <motion.div
                    key={image.id}
          ...
          >
            ...
            <div>
              ...
              <div className="flex gap-3">
                {Array.from(
                  new Set(
                    product.product.variants.map((variant) => variant.option1)
                  )
                ).map((size) => (
                  <motion.button
                    key={size}
            ...
            <div>
              ...
              <div className="flex gap-3">
                {Array.from(
                  new Set(
                    product.product.variants.map((variant) => variant.option2)
                  )
                ).map((color) => (
                  <motion.button
                    key={color}
            ...
            >
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: product.product.body_html }}
              />
            </motion.div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          variants={fadeInUpVariants}
        >
          <h2 className="text-2xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h3 className="font-medium text-xl text-purple-300 mb-6">
                Hard Luggage Specifications
              </h3>
              <ul className="space-y-4">
                {[
                  ...
                  >
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-600 flex items-center justify-center text-xs">
                      ✓
                    </span>
                    <span>{item}</span>
                  </motion.li>
              ...
              <div className="overflow-hidden rounded-xl border border-gray-700 bg-gray-800/50 shadow-lg">
                <table className="min-w-full divide-y divide-gray-700">
                  <thead className="bg-gray-900/50">
                    <tr>
                      <th className="px-6 py-4 text-left text-xs font-medium text-purple-300 uppercase">
                        Size
                      </th>
                      <th className="px-6 py-4 text-left text-xs font-medium text-purple-300 uppercase">
                        Dimensions
        ...
        >
          ...
          <motion.div
            ...
            whileHover={{
              boxShadow:
                "0 20px 25px -5px rgba(139, 92, 246, 0.1), 0 8px 10px -6px rgba(139, 92, 246, 0.1)",
            }}
            transition={{ duration: 0.3 }}
          >
        ...
        <motion.div
          ...
          variants={fadeInUpVariants}
        >
          <h2 className="text-2xl font-bold mb-12 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">
            You Might Also Like
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((item) => (
              ...
              >
                ...
                <h3 className="font-medium text-lg group-hover:text-purple-300 transition-colors">
                  Similar Luggage {item}
                </h3>
      ...
      <div className="relative overflow-hidden bg-gray-900 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Travel in style with our premium luggage collection. Designed for
            the modern traveler.
          </p>
          <motion.button
